"""For training the distilled neural network on mnist figure images.
Example Usage:

mnist_nn = train_distillation(data=MNIST(), 
...
mnist_path = "C:/Users/HP/Desktop/Optimization with Objective Trans and Guassian Smoothing/codes/Draft_Codes/NeuralNet/Data/MNIST_Data/"
class MNIST:
    def __init__(self):
        ...
        self.test_labels = tf.keras.utils.to_categorical(np.load(mnist_path+"y_test.npy"),10)
